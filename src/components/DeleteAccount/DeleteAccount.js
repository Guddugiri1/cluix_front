...
const DeleteAccount = () => {
        ...
        emailjs
          ...
          .then(
            () => {
              console.log("SUCCESS!");
              message.success(
                "Your Account Delete Request is Successfully Send"
              );
  ...
  return (
    <section>
      <div className="overflow-hidden h-[90vh] flex items-center">
          ...
          <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
            ...
            <div className="text-center">
              ...
              <h1 className="text-3xl text-gray-800 font-bold sm:text-5xl lg:text-6xl lg:leading-tight">
                ...
                <span className="text-blue-500">Mobile app account</span>
              </h1>
            </div>
            {/* End Title */}
            {/* Form */}
            <form id="delete-form" onSubmit={sendEmail} ref={form}>
              <div className="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3 bg-white border rounded-lg shadow-lg shadow-gray-100">
                ...
                <div className="pt-2 sm:pt-0 sm:ps-3 border-t border-gray-200 sm:border-t-0 sm:border-s sm:flex-[1_0_0%]">
                  <label
                    ...
                    className="block text-sm font-medium"
                  >
                    <span className="sr-only">Your phone no.</span>
                  </label>
                  <input
                    type="number"
                    id="phone"

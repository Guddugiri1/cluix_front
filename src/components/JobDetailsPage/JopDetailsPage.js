        ...
        <main className="main bg-white px-6 md:px-16 py-20 text-[var(--light-blue)]">
          <div className="flex flex-wrap justify-between max-w-6xl mx-auto">
            ...
            <div className="job-post w-full md:w-8/12">
              ...
              <span
                onClick={showModal}
                className="bg-[#28c0d740] font-bold py-2  text-black text-center block rounded-full "
              >
                Apply for this job
              </span>
            </div>{" "}
            ...
            <div className="w-full hidden md:block md:w-3/12">
              ...
              <a onClick={showModal} className="bg-[#28c0d740] font-semibold  text-black text-center block rounded-full py-2 mb-4">
                Apply for this job
              </a>
            </div>{" "}
          </div>
          ...
          <div className="flex items-center justify-center px-2 py-2">
            ...
            <div className="mx-auto w-full max-w-[550px] bg-white">
              <form>
                ...
                <div>
                  <button className="hover:shadow-form w-full text-lg rounded-md bg-[#28c0d740] py-2 px-6 text-center  font-semibold text-black outline-none">
                    Submit Form
                  </button>
                </div>
              </form>
